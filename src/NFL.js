...
function NFL() {
    ...
    useEffect(() => {
        axios.get(`https://backendforbot4.onrender.com/botwebsites/nfl`)
        .then(res => {
...
function deleteSelected(){
  axios.delete(`https://backendforbot4.onrender.com/botwebsites/nfl/deleteMany`,{data:{id:checkList}})
  .then(response => {
    console.log(response)
     ...
     function handleDelete(id){
      axios.delete(`https://backendforbot4.onrender.com/botwebsites/nfl`,{data:{id:id}})
      .then(response => {
        console.log(response)
      })
      }
