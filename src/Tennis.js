...
function Tennis() {
    ...
    useEffect(() => {
        axios.get(`https://backendforbot4.onrender.com/botwebsites/tennis`)
        .then(res => {
...
function deleteSelected(){
  axios.delete(`https://backendforbot4.onrender.com/botwebsites/tennis/deleteMany`,{data:{id:checkList}})
  .then(response => {
    console.log(response)
     ...
     function handleDelete(id){
      axios.delete(`https://backendforbot4.onrender.com/botwebsites/tennis`,{data:{id:id}})
      .then(response => {
        console.log(response)
      })
      }
