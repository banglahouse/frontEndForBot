...
function NBA() {
    ...
    useEffect(() => {
        axios.get(`https://backendforbot4.onrender.com/botwebsites/nba`)
        .then(res => {
...
function deleteSelected(){
  axios.delete(`https://backendforbot4.onrender.com/botwebsites/nba/deleteMany`,{data:{id:checkList}})
  .then(response => {
    console.log(response)
     ...
     function handleDelete(id){
      axios.delete(`https://backendforbot4.onrender.com/botwebsites/nba`,{data:{id:id}})
      .then(response => {
        console.log(response)
      })
      }
