...
function Football() {
    ...
    useEffect(() => {
        axios.get(`https://backendforbot4.onrender.com/botwebsites/football`)
        .then(res => {
...
function deleteSelected(){
  axios.delete(`https://backendforbot4.onrender.com/botwebsites/football/deleteMany`,{data:{id:checkList}})
  .then(response => {
    console.log(response)
     ...
     function handleDelete(id){
      axios.delete(`https://backendforbot4.onrender.com/botwebsites/football`,{data:{id:id}})
      .then(response => {
        console.log(response)
          // this.setState({ status: response.status });
      })
