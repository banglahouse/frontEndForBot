...
function F1() {
    ...
    useEffect(() => {
        axios.get(`https://backendforbot4.onrender.com/botwebsites/f1`)
        .then(res => {
...
function deleteSelected(){
  axios.delete(`https://backendforbot4.onrender.com/botwebsites/f1/deleteMany`,{data:{id:checkList}})
  .then(response => {
    console.log(response)
     ...
     function handleDelete(id){
      axios.delete(`https://backendforbot4.onrender.com/botwebsites/f1`,{data:{id:id}})
      .then(response => {
        console.log(response)
          // this.setState({ status: response.status });
      })
